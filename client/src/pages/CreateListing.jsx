        ...
        <div className="flex flex-col flex-1 gap-4">
          ...
          <div className="flex gap-4">
            ...
            <button
              ...
              type="button"
              className="p-3 uppercase border border-green-700 text-green-700 rounded hover:shadow-lg disable:opacity-80"
            >
              Upload
            </button>
          </div>
          ...
          <button className="text-white uppercase hover:opacity-95 disabled:opacity-80 p-3 bg-slate-700 rounded-lg">
            Create Listing
          </button>
